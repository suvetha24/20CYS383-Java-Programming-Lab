...
public class HashMapExample {
    ...
    public static void main(String[] args) {
        ...
        rollName.put("CB.EN.U4CYS21078", "Suvetha DP");
        rollName.put("CB.EN.U4CYS21077", "Sushmanth ");
        rollName.put("CB.EN.U4CYS21079", "Swetha V");
        rollName.put("CB.EN.U4CYS21073", "Sudeep V");


        // Retrieve and print the name associated with a specific roll number
        System.out.println(rollName.get("CB.EN.U4CYS21078"));
    }
}
